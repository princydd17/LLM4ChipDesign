...
$PY optimize_adder.py \
  ...
  --top RCA8 \
  --out ../runs/mode_area_rca8 \
  --max-iter 10

$PY plot_ppa.py ../runs/mode_area_rca8/optimization_log.json \
  -o ../runs/mode_area_rca8/ppa_trajectory.pdf

echo "Mode A run complete: ../runs/mode_area_rca8"
