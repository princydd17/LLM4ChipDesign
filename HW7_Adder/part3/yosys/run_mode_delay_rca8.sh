...
$PY optimize_adder.py \
  ...
  --top RCA8 \
  --out ../runs/mode_delay_rca8 \
  --max-iter 10

$PY plot_ppa.py ../runs/mode_delay_rca8/optimization_log.json \
  -o ../runs/mode_delay_rca8/ppa_trajectory.pdf

echo "Mode B run complete: ../runs/mode_delay_rca8"
